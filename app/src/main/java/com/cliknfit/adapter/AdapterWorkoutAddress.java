...
public class AdapterWorkoutAddress extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterWorkoutAddress(Adapterinterface listener, Context context, ArrayList<WorkChildModel> datalist) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return vh = new AdapterWorkoutAddress.AdapterVideoListViewHolder(v);
      /*  } else {
            View v = LayoutInflater.from(parent.getContext()).inflate(
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ((AdapterVideoListViewHolder) holder).title.setVisibility(View.VISIBLE);
