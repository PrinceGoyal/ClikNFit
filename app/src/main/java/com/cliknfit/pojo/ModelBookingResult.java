...
public class ModelBookingResult implements Serializable {
    ...
    private int id, client_id, trainer_id, no_of_people, is_trainer_started, is_client_started, workoutlocation_id,
            price, point, commission, status, display_point, warm_up_min, break_min, cool_min,
            actual_break_min, actual_cool_min, actual_warm_up_min;
    private float hour;
    ...
    private String start_time, end_time, actual_start_time, actual_end_time, location_tag,
            ...
            cool_end_time, break_start_time, break_end_time;

    private TrainerRating trainerrating;


    public TrainerRating getTrainerrating() {
