...
//    private boolean showSideMargin = true;
    ...
    private static int FOREGROUND_COLOR = Color.parseColor("#FC496D");
    ...
    public BarView(Context context, AttributeSet attrs){
        ...
        MINI_BAR_WIDTH = MyUtils.dip2px(context,40);
...
//        this.dataList = null;
     ...
     */
    public void setDataList(ArrayList<Integer> list, int max, int color){
