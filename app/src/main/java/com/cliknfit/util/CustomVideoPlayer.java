...
public class CustomVideoPlayer extends CustomVideoView implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnPreparedListener, View.OnTouchListener {

    /**
     * Log cat TAG name
     */
    private final static String TAG = "CustomVideoPlayer";
    ...
    protected void initObjects() {
        ...
        if (this.videoControlsView == null) {
            ...
            this.videoControlsView = inflater.inflate(R.layout.customvideocontrols, this, false);
        }
        ...
        if (this.videoControlsView != null)
            this.videoControlsView.setVisibility(View.VISIBLE);
    }
    ...
    protected void updateControls() {
        ...
        if (getCurrentState() == State.STARTED) {
            icon = context.getResources().getDrawable(R.drawable.ic_pause);
        } else {
            icon = context.getResources().getDrawable(R.drawable.ic_play_button);
        }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (touchListener != null) {
            return touchListener.onTouch(CustomVideoPlayer.this, event);
        }
